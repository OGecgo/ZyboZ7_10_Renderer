...
proc create_hier_cell_hdmi { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins axi_dynclk_0/S_AXI_LITE] [get_bd_intf_pins S_AXI_LITE]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins axi_vdma_0/M_AXI_MM2S] [get_bd_intf_pins M_AXI_MM2S]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins axi_vdma_0/S_AXI_LITE] [get_bd_intf_pins S_AXI_LITE1]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins v_tc_0/ctrl] [get_bd_intf_pins ctrl]
  ...
  connect_bd_net -net Net  [get_bd_pins REF_CLK_I] \
  ...
  connect_bd_net -net s_axi_lite_aresetn_1  [get_bd_pins s_axi_lite_aresetn] \
...
0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#SD 0#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO} \
...
\
  ...
  # Create instance: Vertex_Transform_Unit_0, and set properties
  set block_name Vertex_Transform_Unit
  set block_cell_name Vertex_Transform_Unit_0
  if { [catch {set Vertex_Transform_Unit_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Vertex_Transform_Unit_0 eq "" } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Vertex_Transform_Unit_0_m_axis [get_bd_intf_pins Vertex_Transform_Unit_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins Vertex_Transform_Unit_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net hdmi_M_AXI_MM2S [get_bd_intf_pins smartconnect_1/S02_AXI] [get_bd_intf_pins hdmi/M_AXI_MM2S]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins Vertex_Transform_Unit_0/s_axi]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins hdmi/S_AXI_LITE]
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins smartconnect_0/M03_AXI] [get_bd_intf_pins hdmi/S_AXI_LITE1]
  connect_bd_intf_net -intf_net smartconnect_0_M04_AXI [get_bd_intf_pins smartconnect_0/M04_AXI] [get_bd_intf_pins hdmi/ctrl]
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M01_AXI [get_bd_intf_pins smartconnect_1/M01_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP1]

  # Create port connections
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn  [get_bd_pins proc_sys_reset_0/peripheral_aresetn] \
  [get_bd_pins smartconnect_0/aresetn] \
  [get_bd_pins Vertex_Transform_Unit_0/aresetn] \
  [get_bd_pins axi_dma_0/axi_resetn] \
  [get_bd_pins smartconnect_1/aresetn] \
  [get_bd_pins hdmi/s_axi_lite_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0  [get_bd_pins processing_system7_0/FCLK_CLK0] \
  [get_bd_pins Vertex_Transform_Unit_0/aclk] \
  ...
  [get_bd_pins hdmi/REF_CLK_I] \
  [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N  [get_bd_pins processing_system7_0/FCLK_RESET0_N] \
  [get_bd_pins proc_sys_reset_0/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Vertex_Transform_Unit_0/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hdmi/axi_dynclk_0/S_AXI_LITE/S_AXI_LITE_reg] -force
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces hdmi/axi_vdma_0/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM]
