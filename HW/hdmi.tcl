...
# Create IP cores
create_bd_cell -type ip -vlnv digilentinc.com:ip:axi_dynclk:1.2 hdmi/axi_dynclk_0
...
connect_bd_net [get_bd_pins hdmi/axi_dynclk_0/REF_CLK_I] [get_bd_pins hdmi/axi_dynclk_0/s_axi_lite_aclk]
