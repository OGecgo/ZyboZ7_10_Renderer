...
//               /home/go/Desktop/ZyboZ7_10_Renderer/workspace_vivado/workspace_vivado.gen/sources_1/bd/operations/ip/operations_AXI_matrix_mul_0_0/operations_AXI_matrix_mul_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "operations_AXI_matrix_mul_0_0,AXI_matrix_mul,{}" *) (* core_generation_info = "operations_AXI_matrix_mul_0_0,AXI_matrix_mul,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=AXI_matrix_mul,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,floatSize=32}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* ip_definition_source = "module_ref" *) (* x_core_info = "AXI_matrix_mul,Vivado 2024.2" *) 
module operations_AXI_matrix_mul_0_0(s_axis_tdata, s_axis_tvalid, s_axis_tlast, 
...
/* synthesis syn_force_seq_prim="aclk" */;
  ...
  (* x_interface_info = "xilinx.com:signal:clock:1.0 aclk CLK" *) (* x_interface_mode = "slave aclk" *) (* x_interface_parameter = "XIL_INTERFACENAME aclk, ASSOCIATED_BUSIF m_axis:s_axis, ASSOCIATED_RESET aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN operations_aclk_0, INSERT_VIP 0" *) input aclk /* synthesis syn_isclock = 1 */;
