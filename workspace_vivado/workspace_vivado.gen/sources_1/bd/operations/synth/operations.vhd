...
--Date        : Tue Jul  8 21:05:29 2025
--Host        : go running 64-bit Arch Linux
--Command     : generate_target operations.bd
--Design      : operations
...
entity operations is
  ...
  attribute CORE_GENERATION_INFO of operations : entity is "operations,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=operations,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=1,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of operations : entity is "operations.hwdef";
end operations;

architecture STRUCTURE of operations is
  component operations_axi_dma_0_0 is
  port (
  ...
  end component operations_axi_dma_0_0;
  component operations_AXI_matrix_mul_0_0 is
  port (
  ...
  end component operations_AXI_matrix_mul_0_0;
  ...
  attribute X_INTERFACE_PARAMETER of aclk_0 : signal is "XIL_INTERFACENAME CLK.ACLK_0, ASSOCIATED_BUSIF S_AXI_LITE_0:M_AXI_S2MM_0:M_AXI_MM2S_0, ASSOCIATED_RESET aresetn_0, CLK_DOMAIN operations_aclk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
  ...
  attribute X_INTERFACE_PARAMETER of M_AXI_S2MM_0_awaddr : signal is "XIL_INTERFACENAME M_AXI_S2MM_0, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN operations_aclk_0, DATA_WIDTH 512, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 1, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 0, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 2, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE WRITE_ONLY, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0";
...
begin
AXI_matrix_mul_0: component operations_AXI_matrix_mul_0_0
     port map (
      aclk => aclk_0,
      aresetn => aresetn_0,
...
axi_dma_0: component operations_axi_dma_0_0
     port map (
