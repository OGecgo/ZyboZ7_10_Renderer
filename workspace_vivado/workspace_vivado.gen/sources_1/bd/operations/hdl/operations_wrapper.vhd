...
--Command     : generate_target operations_wrapper.bd
--Design      : operations_wrapper
...
end operations_wrapper;

architecture STRUCTURE of operations_wrapper is
...
begin
operations_i: component operations
     port map (
