...
HD_PWD='/home/go/Desktop/ZyboZ7_10_Renderer/workspace_vivado/workspace_vivado.runs/main_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_axi_smc_0.tcl
