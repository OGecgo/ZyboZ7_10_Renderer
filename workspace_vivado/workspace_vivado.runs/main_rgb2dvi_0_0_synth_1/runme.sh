...
HD_PWD='/home/go/Desktop/ZyboZ7_10_Renderer/workspace_vivado/workspace_vivado.runs/main_rgb2dvi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_rgb2dvi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_rgb2dvi_0_0.tcl
