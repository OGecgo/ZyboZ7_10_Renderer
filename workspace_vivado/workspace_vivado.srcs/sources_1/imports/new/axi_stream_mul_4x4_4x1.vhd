...
entity axi_stream_mul_4x4_4x1 is
    ...
    Port (
        ...
        data_matrix: in  signed(size_data * 16 - 1 downto 0);

        clk:  in std_logic;
        arst: in std_logic -- active low 
    );
end axi_stream_mul_4x4_4x1;

architecture Behavioral of axi_stream_mul_4x4_4x1 is
...
begin
    ...
    gen_mul: for i in 0 to 3 generate
        u_mul: mul_1x4_4x1 
            ...
            port map(
                ...
                s_tdata_left   => data_matrix(size_data * (16 - i * 4) - 1 downto size_data * (12 - i * 4)), 
                s_tdata_right  => s_tdata,
    ...
    m_tvalid_temp <= m_tvalid_array(3) and m_tvalid_array(2) and m_tvalid_array(1) and m_tvalid_array(0);


    m_tvalid <= m_tvalid_temp;
    s_tready <= s_tready_array(3) and s_tready_array(2) and s_tready_array(1) and s_tready_array(0);

    m_tlast <= s_tlast and m_tvalid_temp;
end Behavioral;
