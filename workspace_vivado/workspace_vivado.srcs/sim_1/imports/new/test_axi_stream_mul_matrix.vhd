...
architecture Behavioral of test_axi_stream_mul_matrix is
    ...
    -- 16 elements (4x4)
    signal s_tdata  : signed(size_data * 4 - 1 downto 0) := (others => '0');
...
begin
    ...
    begin
        ...
        wait for 20 ns;
        s_tdata <= to_signed(3, size_data) & to_signed(8, size_data) & to_signed(2, size_data) & to_signed(1, size_data);
        wait for 20 ns;
        s_tdata <= to_signed(5, size_data) & to_signed(2, size_data) & to_signed(1, size_data) & to_signed(9, size_data);
        wait for 20 ns;
        s_tdata <= to_signed(3, size_data) & to_signed(2, size_data) & to_signed(2, size_data) & to_signed(2, size_data);


        wait for 20 ns;
        s_tid <= '0';
        s_tdata <= to_signed(3, size_data)&
