...
#
# Script generated by Vivado on Tue Jul 08 21:05:32 EEST 2025
...
#
# Usage        : operations.sh
#                operations.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                operations.sh [-reset_run]
#                operations.sh [-reset_log]
#                operations.sh [-help]
#
...
#                script (type 'operations.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname lib_pkg_v1_0_4 -libname fifo_generator_v13_2_11 -libname lib_fifo_v1_0_20 -libname lib_srl_fifo_v1_0_4 -libname lib_cdc_v1_0_3 -libname axi_datamover_v5_1_35 -libname axi_sg_v4_1_19 -libname axi_dma_v7_1_34 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm lib_pkg_v1_0_4 fifo_generator_v13_2_11 lib_fifo_v1_0_20 lib_srl_fifo_v1_0_4 lib_cdc_v1_0_3 axi_datamover_v5_1_35 axi_sg_v4_1_19 axi_dma_v7_1_34 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "operations.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./operations.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work fifo_generator_v13_2_11 $xmvlog_opts +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.operations xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.operations -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/go/Desktop/ZyboZ7_10_Renderer/workspace_vivado/workspace_vivado.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log operations_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./operations.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: operations.sh [-help]\n\
Usage: operations.sh [-step]\n\
Usage: operations.sh [-lib_map_path]\n\
Usage: operations.sh [-reset_run]\n\
Usage: operations.sh [-reset_log]\n\
Usage: operations.sh [-keep_index]\n\
Usage: operations.sh [-noclean_files]\n\n\
