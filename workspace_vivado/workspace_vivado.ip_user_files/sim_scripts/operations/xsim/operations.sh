...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L lib_pkg_v1_0_4 -L fifo_generator_v13_2_11 -L lib_fifo_v1_0_20 -L lib_srl_fifo_v1_0_4 -L lib_cdc_v1_0_3 -L axi_datamover_v5_1_35 -L axi_sg_v4_1_19 -L axi_dma_v7_1_34 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot operations xil_defaultlib.operations xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim operations -key {Behavioral:sim_1:Functional:operations} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_ac0c.protoinst" -protoinst "protoinst_files/main.protoinst" -protoinst "protoinst_files/operations.protoinst" -protoinst "protoinst_files/operations_inst_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb operations.wdb xsim.dir libdpi.so)
