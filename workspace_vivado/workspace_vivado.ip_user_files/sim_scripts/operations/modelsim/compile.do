...
vlog -work xpm -64 -incr -mfcu  -sv -L axi_vip_v1_1_19 -L smartconnect_v1_0 -L processing_system7_vip_v1_0_21 -L xilinx_vip "+incdir+/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
vlog -work fifo_generator_v13_2_11 -64 -incr -mfcu  "+incdir+/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
