...
design_libs=(xilinx_vip xpm lib_pkg_v1_0_4 fifo_generator_v13_2_11 lib_fifo_v1_0_20 lib_srl_fifo_v1_0_4 lib_cdc_v1_0_3 axi_datamover_v5_1_35 axi_sg_v4_1_19 axi_dma_v7_1_34 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work fifo_generator_v13_2_11 $vlogan_opts +v2k +incdir+"/tools/Xilinx/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.operations xil_defaultlib.glbl -o operations_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./operations_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/go/Desktop/ZyboZ7_10_Renderer/workspace_vivado/workspace_vivado.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key operations_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc operations_simv.daidir vcs_lib c.obj)
